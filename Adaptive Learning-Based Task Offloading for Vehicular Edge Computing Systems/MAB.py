...
if __name__ == "__main__":
    ...
    for i in range(3000):
        ...
        for key in N_t:
            ...
            h_t_n[key] = A_0/(math.pow(N_t[key].getLocation()-car.getLocation(),4))
        ...
        for key in N_t:
            if key not in k_n.keys():
                ...
                r_d_t_n = r_u_t_n
                print(h_t_n[key],A_0*cal(key,N_t),P*h_t_n[key]/(P*A_0*cal(key,N_t)+sigma_2),math.log(1+(P*h_t_n[key])/(sigma_2+P*A_0*cal(key,N_t)),2))
